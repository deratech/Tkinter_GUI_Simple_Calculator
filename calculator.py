...
'''
 create our own class which extends the ttk.Frame class
'''
class calculator(ttk.Frame):
    ...
    def calculate(self):
        ...
        num3 = num1 + num2
        self.answer_label['text'] = round(num3, 2)
...
'''
create  top level widget; the main window of the application 
and then create an instance of our class and start it’s mainloop
'''
